...
sbatch slurm/run_on_vllm_amdgpufast2.bash "hugging-quants/Meta-Llama-3.1-70B-Instruct-AWQ-INT4" --ds="openai/gsm8k" --train_batch_size=8 --combine_co_mut --scorer="binary_match" --initial_population_size 12 --mating_pool_size 6 --max_iters 5 --temp 0.5